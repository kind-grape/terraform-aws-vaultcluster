...
#   value = "${module.sg_consul_backend.nsg_name}"
# }
#
# output "nsg_consulbk_id" {
#   value = "${module.sg_consul_backend.nsg_id}"
# }
#
...
#   value = ["${module.consul_backend.server_ids}"]
# }
#
...
#   value = "${module.sg_consul_sd.nsg_name}"
# }
#
# output "nsg_consulsd_id" {
#   value = "${module.sg_consul_sd.nsg_id}"
# }
#
...
#   value = "${module.sg_vault.nsg_name}"
# }
#
# output "nsg_vault_id" {
#   value = "${module.sg_vault.nsg_id}"
# }
#
